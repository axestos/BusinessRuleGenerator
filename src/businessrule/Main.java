...
public class Main {
	...
	public static void main(String[] args) {
		...
		new AttributeListRule(102, "Quinten",  "Attribute", "In", "Order.status", "'shipped','in warehouse','delivered','waiting on invoice'");
		...
		new InterEntityCompareRule(105,"Dennis", "InterEntity", "GreaterThan", "School.klaslokaal", "Klas.leerlingen", true, "Leerlingen in een Klas mag niet groter zijn dan Klaslokaal in School", "Before");
	}
}