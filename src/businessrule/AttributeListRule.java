...
public class AttributeListRule extends BusinessRule {
	...
	public AttributeListRule(int ruleid, String authorid, String type, String operator, String first, String last) {
		...
		generateAttributeListRule(ruleid, authorid, type, operator, first, last);
	}

	private void generateAttributeListRule(int ruleid, String authorid, String type, String operator, String first, String last){
