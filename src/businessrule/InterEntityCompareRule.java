...
public class InterEntityCompareRule extends BusinessRule {
	...
	public InterEntityCompareRule(int ruleid, String authorid, String type, String operator, String first, String last, boolean interEntityModifiable, String errorCode, String beforeAfter) {
		...
		generateInterEntityCompareRule(ruleid, type, first, last, interEntityModifiable, errorCode, beforeAfter);
	}
	
	
	public void generateInterEntityCompareRule(int ruleid, String type, String first, String last, boolean interEntityModifiable, String errorCode, String beforeAfter){
	...
	public String toStringTableTwo(String triggername, String attrTable2, String cursorID_table2, String tablename_attr2, String remoteID_attr2, String tablename_attr1, String remoteID_attr1, String errorCode, String beforeAfter){
		String generatedDeclare = "Create or replace trigger "+triggername+
